...
def branch_and_bound(graph, start_node, goal_node):
    visited = set()
    min_heap = []
    heapq.heappush(min_heap, (0, start_node, [start_node])) 
    ...
    while min_heap:
        ...
        for neighbor in graph.neighbors(current_node):
            if neighbor not in visited:
                ...
                heapq.heappush(min_heap, (new_cost + heuristic, neighbor, new_path))
...
start_node = 1  # Source
goal_node = 5   # Goal
visited_nodes = branch_and_bound(G, start_node, goal_node)
